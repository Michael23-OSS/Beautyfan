...
<body>
    <center>
    <h2 style="color:white;">𝕭𝖊𝖆𝖚𝖙𝖞 𝕱𝖆𝖓</h2>
    </center>
    ...
    <form action="login.php" method="post">
            ...
            <div class="forgot">
                <a href="https://BeautyFan.blogspot.com/search/label/Sistemas%20VIP"  >Beauty Fan Blog</a>

                <p><input type="checkbox">Recordar password</p>
            </div>
            <button type="submit" name="login">Login</button>
        </form>
        <p class=" w3l-register-p">𝕭𝖊𝖆𝖚𝖙𝖞 𝕱𝖆𝖓 𝕷𝖔𝖌𝖎𝖓</p>
    </div>
    <footer>
