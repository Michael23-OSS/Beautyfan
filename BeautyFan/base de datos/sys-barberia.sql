...
--
-- Estructura de tabla para la tabla `categoria_gastos_estante`
--

CREATE TABLE `categoria_gastos_estante` (
  `id_categoria` int(200) NOT NULL,
  `descripcion` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `categoria_gastos_estante`
--

INSERT INTO `categoria_gastos_estante` (`id_categoria`, `descripcion`) VALUES
(4, 'gel'),
(5, 'tintes');
...
CREATE TABLE `cita` (
  ...
  `id_beneficiario` int(200) NOT NULL,
  `id_barbero` int(200) NOT NULL,
  `fecha` date NOT NULL,
...
INSERT INTO `cita` (`id_cita`, `id_beneficiario`, `id_barbero`, `fecha`, `estado_cita`, `observaciones`, `horario`) VALUES
...
--
-- Estructura de tabla para la tabla `detalles_pedido_cosmetico`
--

CREATE TABLE `detalles_pedido_cosmetico` (
  `id_detalles` int(200) NOT NULL,
  `id_pedido` int(200) NOT NULL,
  `id_producto` int(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `detalles_pedido_cosmetico`
--

INSERT INTO `detalles_pedido_cosmetico` (`id_detalles`, `id_pedido`, `id_producto`, `cantidad`, `id_cliente`) VALUES
(3, 3, 4, 2, 20),
(4, 4, 5, 1, 20),
(5, 5, 5, 2, 20);
...
CREATE TABLE `detalle_compra` (
  `id_detalle_compra` int(200) NOT NULL,
  `cosmetico` varchar(200) NOT NULL,
  `cantidad` varchar(200) NOT NULL,
...
INSERT INTO `detalle_compra` (`id_detalle_compra`, `cosmetico`, `cantidad`, `frecuencia`, `dias`, `instruccion`, `id_compra`) VALUES
(1, 'fijador', '1', '1 ves al dia', 3, 'cabello lasio', 2);
...
(1, 'Beauty Fan', '4324547376', 'Quito', '0983022010', 'Centro Estilista y barberia profesional enfocada al usuario', 'beautyfan.jpg', 'BeautyFan@gmail.com', '$./', 'dolar');
...
--
-- Estructura de tabla para la tabla `gastos_estante`
--

CREATE TABLE `gastos_estante` (
  `id_gastos` int(200) NOT NULL,
  `cantidad` int(200) NOT NULL,
  `nota` varchar(200) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Volcado de datos para la tabla `gastos_estante`
--

INSERT INTO `gastos_estante` (`id_gastos`, `cantidad`, `nota`, `fecha`, `id_categoria`) VALUES
...
CREATE TABLE `horario_barbero` (
  `id_horario_barbero` int(200) NOT NULL,
...
--
-- Volcado de datos para la tabla `horario_barbero`
--

INSERT INTO `horario_barbero` (`id_horario_barbero`, `dia_laborable`, `hora_inicio`, `hora_fin`, `cita_duracion`, `id_barbero`) VALUES
...
INSERT INTO `pedidos` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`, `tipo_venta`, `monto_pagado`, `total`, `id_barbero`) VALUES
...
--
-- Estructura de tabla para la tabla `pedido_cosmetico`
--

CREATE TABLE `pedido_cosmetico` (
  `id_pedido` int(200) NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Volcado de datos para la tabla `pedido_barbero`
--

INSERT INTO `pedido_cosmetico` (`id_pedido`, `fecha`, `id_sesion`, `id_cliente`, `tipo_venta`, `monto_pagado`, `total`, `id_barbero`) VALUES
...
INSERT INTO `compra` (`id_compra`, `id_cliente`, `id_barbero`, `historia`, `id_sesion`, `fecha`) VALUES
(1, 20, 17, 'corto', 17, '2020-08-09'),
(2, 20, 8, 'casual', 17, '2020-08-09');
...
(1, 'Corte Militar', 'realizado on exito', 34, 'a');
...
(5, 'alchol', 'para las patillas', 'botella', 70, 50, '', '150', 'a');
...
(5, 'admin', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'admin.png', 'administrador', 'sistemas', 'en oferta', '54345', 'tusolutionweb@gmail.com'),
(6, 'siba', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'img.jpg', 'recepcionista', 'siba', 'siba', '2342423', 'siba@gmail.com'),
(7, 'federico', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'user.png', 'vendedor', 'federico', 'federico', 'federico', 'federico@gmail.com'),
(8, 'worrent', 'a1Bz20ydqelm8m1wql1574612a64e746d204acae6e51b7d695', 'user2.png', 'barbero', 'worrent', 'yafe', '3253453453', 'worrent@gmail.com'),
(9, 'pedro', 'a1Bz20ydqelm8m1wqlc6cc8094c2dc07b700ffcc36d64e2138', 'user3.png', 'beneficiario', 'Pedro', 'Suares', '234324234', 'pedro@gmail.com'),
(12, 'willian', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'user3.png', 'medico', 'willian hart', 'Walllace', '242342432', 'willian@gmail.com'),
(13, 'bills', 'a1Bz20ydqelm8m1wqlb5237b6a7892a42a4a7a60fdfbe828b9', 'user2.png', 'beneficiario', 'bills', 'Mc donald', '1312312213', 'bills@gmail.com'),
(14, 'aaron', 'a1Bz20ydqelm8m1wqle10adc3949ba59abbe56e057f20f883e', 'user2.png', 'beneficiario', 'Aaron ', 'Swarss', '2423424', 'aaron@gmail.com'),
(16, 'carla', 'a1Bz20ydqelm8m1wql1fa4a2211b4e290f2a066de6b84187ec', 'user.png', 'beneficiario', 'Carla ', 'Diaz', '345353', 'carla@gmail.com'),
(17, 'barbero', 'a1Bz20ydqelm8m1wql652044ac6e008761b3e6141748a99880', 'user.png', 'barbero', 'diego', 'flores', '09809809', 'medico@gmail.com'),
(18, 'vendedor', 'a1Bz20ydqelm8m1wql438b1c1dd3c58717ddab1447194146b3', 'user.png', 'vendedor', 'mateo', 'llanos', '987987988', 'farmace@gmail.com'),
(19, 'recep', 'a1Bz20ydqelm8m1wql746035f8741e922eb5fa31ea766d9ece', 'user.png', 'recepcionista', 'maria', 'lingo', '97979', 'recep@gmail.com'),
(20, 'beneficiario', 'a1Bz20ydqelm8m1wqld243800a7d0ba0f87081bcdd832bb05f', 'user.png', 'beneficiario', 'rodrigo', 'llanos', '98798798', 'paciente@gmail.com');
...
INSERT INTO `vacaciones` (`id_vacaciones`, `fecha`, `id_barbero`) VALUES
(1, '2020-08-21', 17),
(2, '2020-08-28', 17),
(3, '2020-08-29', 17);
...
--
-- Indices de la tabla `categoria_gastos_estante`
--
ALTER TABLE `categoria_gastos_estante`
  ADD PRIMARY KEY (`id_categoria`);
...
--
-- Indices de la tabla `detalles_pedido_cosmetico`
--
ALTER TABLE `detalles_pedido_cosmetico`
  ADD PRIMARY KEY (`id_detalles`);
...
--
-- Indices de la tabla `gastos_estante`
--
ALTER TABLE `gastos_estante`
  ADD PRIMARY KEY (`id_gastos`);
...
ALTER TABLE `horario_barbero`
  ADD PRIMARY KEY (`id_horario_barbero`);
...
--
-- Indices de la tabla `pedido_cosmetico`
--
ALTER TABLE `pedido_cosmetico`
  ADD PRIMARY KEY (`id_pedido`);
...
--
-- AUTO_INCREMENT de la tabla `categoria_gastos_estante`
--
ALTER TABLE `categoria_gastos_estante`
...
--
ALTER TABLE `detalle_compra`
  MODIFY `id_detalle_compra` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `gastos_estante`
--
ALTER TABLE `gastos_estante`
...
--
ALTER TABLE `horario_barbero`
  MODIFY `id_horario_barbero` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `pedido_cosmetico`
--
ALTER TABLE `pedido_cosmetico`
...
--
ALTER TABLE `compra`
  MODIFY `id_compra` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
