...
$nombre_cliente="";
    ...
    $query3=mysqli_query($con,"select * from compra p inner join usuario c on c.id = p.id_cliente where id_compra= '$id_compra' ")or die(mysqli_error($con));
...
$color= '#f5f5f5';
 ...
 $con_letra=strtoupper($V->ValorEnLetras($sub,$tipo_moneda)); 
  ...
  ';
    $query=mysqli_query($con,"select * from detalle_compra 
 where  id_compra='$id_compra'   ")or die(mysqli_error());
    $i=1;
