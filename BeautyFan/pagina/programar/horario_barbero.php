...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from horario_barbero  ")or die(mysqli_error());
    $i=1;
...
?>
      ...
      <td><?php echo $row['cita_duracion'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../programar/eliminar_horario_barbero.php?id_horario_barbero=$id_horario_barbero";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario ??');"><i class="glyphicon glyphicon-remove"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
