...
?>
 ...
 <!--end of modal-->
              ...
              <a class="btn btn-warning btn-print" href="gastos_estante.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
<?php
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from gastos_estante where id_gastos= '$id_gastos' ")or die(mysqli_error());
    $i=1;
...
?>
        ...
        <form class="form-horizontal" method="post" action="gastos_estante_actualizar.php" enctype='multipart/form-data'>
  ...
  <div class="row">
       ...
       <div class="row">
            ...
            <select class="form-control select2" name="id_categoria" required>
              ...
              $queryc=mysqli_query($con,"select * from categoria_gastos_estante")or die(mysqli_error());
