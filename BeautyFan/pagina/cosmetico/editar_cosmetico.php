...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title"> MODIFICAR COSMETICO</h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-warning btn-print" href="cosmetico.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
?>
        ...
        <form class="form-horizontal" method="post" action="cosmetico_actualizar.php" enctype='multipart/form-data'>
