...
?>
  ...
  <section class="content">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <?php foreach($_SESSION["carrito_pres"] as $indice => $compra){ 
        ...
        <tr>
          ...
          <td><?php echo $compra->cosmetico ?></td>
          <td><?php echo $compra->cantidad ?></td>
          <td><?php echo $compra->frecuencia ?></td>
              <td><?php echo $compra->dias ?></td>
 
          <td><a class="btn btn-danger" href="../compra/<?php  echo "quitarDelCarrito.php?indice=$indice";?>"><i class="fa fa-trash"></i></a>
...
<div id="suggestions"></div>
   ...
   <br>   <br> 
      ...
      <form  class="form-inline" name="f1" action="../compra/terminarVenta.php" method="POST">
...
<div class="modal fade" id="miModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <div class="col-md-12 btn-print">
                      <div class="form-group">
                        <label for="date" class="col-sm-3 control-label">Cosmetico</label>
                        <div class="input-group col-sm-8">
                          <input type="text" class="form-control pull-right" id="cosmetico" name="cosmetico" placeholder="aceitilina" required >
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
   ...
   <div class="col-md-12 btn-print">
                      <div class="form-group">
                        ...
                        <div class="input-group col-sm-8">
                          <input type="text" class="form-control pull-right" id="cantidad" name="cantidad" placeholder="100ml" required >
                        </div><!-- /.input group -->
                      </div><!-- /.form group -->
                    </div>
   <div class="col-md-12 btn-print">
