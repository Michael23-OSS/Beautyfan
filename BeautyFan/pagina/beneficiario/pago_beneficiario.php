...
?>
 ...
 <!--end of modal-->
                 ...
                 <a class="btn btn-primary btn-print" href="../pos_cosmetico/<?php  echo "pos_cosmetico.php?cid=$cid";?>"    style="height:25%; width:15%; font-size: 12px " role="button">Agregar</a>   
      <br>           
              <a class="btn btn-warning btn-print" href="../beneficiario/beneficiario.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
<br>
