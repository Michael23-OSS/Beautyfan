...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select m.nombre as  barbero,p.nombre as  beneficiario,c.fecha,c.observaciones,c.estado_cita,c.id_cita from cita c inner join usuario m on c.id_barbero = m.id inner join usuario p on p.id = c.id_beneficiario and c.fecha='$fecha' ")or die(mysqli_error());
    $i=0;
