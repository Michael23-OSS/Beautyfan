...
<html>
  <head>
    <link rel="stylesheet" href="../pos_cosmetico/css/styles.css">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    ...
    <title>Pos cosmetico </title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="../pos_cosmetico/public/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="../pos_cosmetico/public/css/font-awesome.css">
   
    <!-- Theme style -->
    <link rel="stylesheet" href="../pos_cosmetico/public/css/AdminLTE.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="../pos_cosmetico/public/css/blue.css">
    ...
    <style type="text/css">
      #myInput {
  background-image: url('../pos_cosmetico/css/buscador.png'); /* Add a search icon to input */
...
?>
  ...
  <section class="content">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <?php foreach($_SESSION["carrito"] as $indice => $cosmetico){ 
            $granTotal += $cosmetico->total;


          ?>
        <tr>

          <td><?php echo $cosmetico->nombre ?></td>
          <td><?php echo $cosmetico->precio_venta ?></td>
          <td><?php echo $cosmetico->cantidad ?></td>
          <td><?php echo $cosmetico->total ?></td>
          <td><a class="btn btn-danger" href="../pos_cosmetico/<?php  echo "quitarDelCarrito.php?cid=$cid&indice=$indice";?>"><i class="fa fa-trash"></i></a>
     ...
     <h3> Total: <?php echo $granTotal; ?></h3>
                  ...
                  <div class="box-footer">
                    ...
                    <a type="button" href="../beneficiario/<?php  echo "pago_beneficiario.php?cid=$cid";?>" class="btn btn-danger">Regresar</a>
                  </div>
                </form>
              </div><!-- /.box -->
...
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="../pos_cosmetico/agregar_carrito.php" >
...
function sumar (valor) {
 var impuTotal  = '<?php echo $impuTotal; ?>';
    ...
    <!-- jQuery 2.1.4 -->
    <script src="../pos_cosmetico/public/js/jquery.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="../pos_cosmetico/public/js/bootstrap.min.js"></script>
    <!-- iCheck -->
    <script src="../pos_cosmetico/public/js/icheck.min.js"></script>
