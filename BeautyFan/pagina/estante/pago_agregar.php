...
#myUL li a:hover:not(.header) {
  ...
  <body class="hold-transition login-page">
           <?php    
if(!isset($_SESSION["carrito_estante"])) $_SESSION["carrito_estante"] = [];
$granTotal = 0;
$impuTotal = 0;
?>
  <div class="col-xs-12">
  ...
  <section class="content">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        <?php foreach($_SESSION["carrito_estante"] as $indice => $producto){ 
        ...
        <tr>
          ...
          <td><a class="btn btn-danger" href="../estante/<?php  echo "quitarDelCarrito.php?indice=$indice";?>"><i class="fa fa-trash"></i></a>
...
<div id="suggestions"></div>
   ...
   <br>   <br> 
      ...
      <form  class="form-inline" name="f1" action="../estante/terminarVenta.php" method="POST">
...
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <form class="form-horizontal" method="post" action="../estante/agregar_carrito.php" >
