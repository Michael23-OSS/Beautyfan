...
           </div>
           <div class="col-md-3">
             <form method="post" action="../estante/reportes_pagos_por_fecha.php" enctype="multipart/form-data" class="form-horizontal">
...
$precio_venta=0;
$precio_compra=0;
    $query=mysqli_query($con,"select * from pedidos where fecha<='$fecha_final' and  fecha>='$fecha_inicio'")or die(mysqli_error());
