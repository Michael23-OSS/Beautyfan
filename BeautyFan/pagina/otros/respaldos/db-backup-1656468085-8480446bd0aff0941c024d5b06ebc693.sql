...
CREATE TABLE `compra` (
  `id_compra` int(200) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `detalle_compra` (
  `id_detalle_compra` int(200) NOT NULL AUTO_INCREMENT,
...
INSERT INTO detalle_compra VALUES("1","fijador","1","1 ves al dia","3","cabello lasio","2");
...
INSERT INTO empresa VALUES("1","Beauty Fan","4324547376","Quito","0983022010","Centro Estilista y barberia profesional enfocada al usuario","beautyfan.jpg","BeautyFan@gmail.com","$./","dolar");
...
CREATE TABLE `horario_barbero` (
  `id_horario_barbero` int(200) NOT NULL AUTO_INCREMENT,
...
INSERT INTO usuario VALUES("1","admin","a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3","admin.png","administrador","Administrador","Administrador","0983022010","BeautyFan@gmail.com"),
("2","barbero","barbero","img.jpg","barbero","barbero","barbero","0932574187","barbero@gmail.com"),
("3","beneficiario","beneficiario","user.png","beneficiario","beneficiario","beneficiario","0935214784","beneficiario@gmail.com"),
("4","recepcionista","recepcionista","user2.png","recepcionista","recepcionista","recepcionista","0935214784","beneficiario@gmail.com"),
("5","vendedor","vendedor","user3.png","vendedor","vendedor","vendedor","0935874261","vendedor@gmail.com");
