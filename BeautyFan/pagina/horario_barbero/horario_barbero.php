  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
                        <div class="box-body">
                  <!-- Date range -->
                  <form method="post" action="horario_barbero_add.php" enctype="multipart/form-data" class="form-horizontal">
                      <input type="hidden" class="form-control" id="id_barbero" name="id_barbero" value="<?php echo $cid;?>" required>
...
<?php
   ...
   // $branch=$_SESSION['branch'];
    $query=mysqli_query($con,"select * from horario_barbero where id_barbero='$cid' ")or die(mysqli_error());
    $i=1;
    while($row=mysqli_fetch_array($query)){

$id_horario_barbero=$row['id_horario_barbero'];
...
?>
      ...
      <td><?php echo $row['cita_duracion'];?></td>
                    ...
                    //  if ($eliminar=="si") {
                      ...
                      ?>
   <a class="small-box-footer btn-print"  href="<?php  echo "../horario_barbero/eliminar_horario_barbero.php?id_horario_barbero=$id_horario_barbero&cid=$cid";?>" onClick="return confirm('¿Está seguro de que quieres eliminar horario ??');"><i class="glyphicon glyphicon-remove"></i></a>
   <?php
                  //    }
                      ?>
                               <?php
